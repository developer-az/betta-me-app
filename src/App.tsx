...
function Dashboard({ tank, fish, water, setTank, setFish, setWater }: { tank: TankState; fish: FishState; water: WaterState; setTank: (t: TankState) => void; setFish: (f: FishState) => void; setWater: (w: WaterState) => void; }) {
  ...
  let score = 100;
  // Tank
  if (tank.size < 5) score -= 30;
  else if (tank.size < 10) score -= 10;
  ...
  function getGroupedIssueAnalysis() {
    ...
    const causes = [
      ...
      },
      {
        ...
        tip: 'A 5+ gallon tank is best for betta health.'
      },
  ...
  const groupedIssues = happy ? [] : getGroupedIssueAnalysis();
  ...
  return (
    <div className="adventure-screen dashboard-screen" style={{ maxWidth: 900, margin: '0 auto', padding: 16 }}>
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', gap: 24, justifyContent: 'center', marginBottom: 24 }}>
        <div className="card-section" style={{ background: '#e3f2fd', borderRadius: 12, padding: 18, minWidth: 220, flex: 1 }}>
        ...
        <div className="card-section" style={{ background: '#f3f6fa', borderRadius: 12, padding: 18, minWidth: 220, flex: 1 }}>
          <div style={{ fontWeight: 700, fontSize: 18, marginBottom: 8 }}>🐠 Betta</div>
          <div style={{ display: 'flex', alignItems: 'center', marginBottom: 8 }}>
            <FishSVG color={fish.color} mood={happy ? 'happy' : 'sad'} />
            <span style={{ marginLeft: 12, fontWeight: 600 }}>{fish.name}</span>
          </div>
          <div><strong>Color:</strong> <span style={{ color: fish.color }}>{fish.color}</span></div>
        </div>
        <div className="card-section" style={{ background: '#e8f5e9', borderRadius: 12, padding: 18, minWidth: 220, flex: 1 }}>
        ...
        <div className="card-section" style={{ background: '#fffde7', borderRadius: 12, padding: 18, minWidth: 220, flex: 1 }}>
